...
@Component({
  ...
  template: `
    <!-- Hero Banner -->
    <div class="relative py-20 lg:py-28 bg-emerald-950 text-white overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-4">
        ...
        <p class="text-sm sm:text-base text-emerald-100 max-w-2xl mx-auto font-medium">
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="mt-12 p-8 bg-gradient-to-br from-emerald-900 to-teal-950 text-white rounded-3xl shadow-xl flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div class="flex items-center gap-3 shrink-0">
            <a href="https://wa.me/919876543210" target="_blank" class="px-5 py-3 bg-[#25D366] hover:bg-[#20BD5A] text-white font-black text-xs rounded-xl shadow-md transition flex items-center gap-2">
            ...
            <a href="tel:+919876543210" class="px-5 py-3 bg-white/10 hover:bg-white/20 text-white font-bold text-xs rounded-xl border border-white/20 transition">
              📞 Call
            </a>
          </div>
        </div>
