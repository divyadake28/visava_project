...
class AdminSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            ['key' => 'site_email', 'value' => 'Visawaagrotourism@gmail.com', 'group' => 'contact'],
            ['key' => 'site_phone', 'value' => '+91 91581 41414', 'group' => 'contact'],
            ['key' => 'address_mr', 'value' => 'विसावा ॲग्रो टुरिझम – बाबांचा मळा, धुळे–सोलापूर हायवे, करोडी टोल नाक्याजवळ, हॉटेल अमृताच्या मागे, करोडी, वाळूज, छत्रपती संभाजीनगर (औरंगाबाद), महाराष्ट्र ४३११३६, भारत', 'group' => 'contact'],
            ['key' => 'address_en', 'value' => 'Visawa Agro Tourism – Babacha Mala, Dhule–Solapur Highway, Near Karodi Toll Plaza, Behind Hotel Amruta, Karodi, Waluj, Chhatrapati Sambhajinagar (Aurangabad), Maharashtra 431136, India', 'group' => 'contact'],
            ['key' => 'logo', 'value' => '', 'group' => 'general'],
            ['key' => 'favicon', 'value' => '', 'group' => 'general'],

            ['key' => 'facebook_url', 'value' => 'https://facebook.com/visawa', 'group' => 'social'],
            ['key' => 'instagram_url', 'value' => 'https://www.instagram.com/visawaagrotourism', 'group' => 'social'],
            ...
            ['key' => 'hero_image', 'value' => 'uploads/settings/visawa_grand_entrance_hero.jpg', 'group' => 'hero'],
            ['key' => 'about_image', 'value' => 'uploads/settings/visawa_farmer_bullocks_about.jpg', 'group' => 'about'],
        ];
        ...
        $packages = [
            [
                ...
                'featured_image' => 'uploads/activities/visawa_vineyard_patio.jpg',
                'status' => 'active',
                'is_active' => true,
                'is_featured' => true,
                'created_by' => $admin->id,
            ...
            [
                ...
                'featured_image' => 'uploads/activities/visawa_rural_relaxation.jpg',
                'status' => 'active',
                'is_active' => true,
                'is_featured' => true,
                'created_by' => $admin->id,
            ...
            [
                ...
                'featured_image' => 'uploads/activities/visawa_village_school.jpg',
                'status' => 'active',
                'is_active' => true,
                'is_featured' => true,
                'created_by' => $admin->id,
            ...
            [
                ...
                'featured_image' => 'uploads/packages/visawa_corporate_lawn.jpg',
                'status' => 'active',
                'is_active' => true,
                'is_featured' => false,
                'created_by' => $admin->id,
            ...
            [
                ...
                'featured_image' => 'uploads/packages/visawa_vintage_car_group.jpg',
                'status' => 'active',
                'is_active' => true,
                'is_featured' => false,
                'created_by' => $admin->id,
            ...
            [
                ...
                'featured_image' => 'uploads/packages/visawa_cottage_stay.jpg',
                'status' => 'active',
                'is_active' => true,
                'is_featured' => false,
                'created_by' => $admin->id,
        ...
        $events = [
            [
                ...
                'image' => 'uploads/packages/visawa_corporate_lawn.jpg',
                'banner_image' => 'uploads/packages/visawa_corporate_lawn.jpg',
                'status' => 'active',
                'is_active' => true,
                'created_by' => $admin->id,
            ],
            [
                ...
                'image' => 'uploads/activities/visawa_village_school.jpg',
                'banner_image' => 'uploads/activities/visawa_village_school.jpg',
                'status' => 'active',
                'is_active' => true,
                'created_by' => $admin->id,
            ],
            ...
            [
                ...
                'image' => 'uploads/activities/visawa_rural_relaxation.jpg',
                'banner_image' => 'uploads/activities/visawa_rural_relaxation.jpg',
                'status' => 'active',
                'is_active' => true,
                'created_by' => $admin->id,
            ],
            [
                ...
                'image' => 'uploads/events/visawa_cartwheel_bridge.jpg',
                'banner_image' => 'uploads/events/visawa_cartwheel_bridge.jpg',
                'status' => 'active',
                'is_active' => true,
                'created_by' => $admin->id,
            ],
            [
                ...
                'image' => 'uploads/events/visawa_folk_art_tractor.jpg',
                'banner_image' => 'uploads/events/visawa_folk_art_tractor.jpg',
                'status' => 'active',
                'is_active' => true,
                'created_by' => $admin->id,
            ],
        ...
        $galleryItems = [
            // Farm & Nature
            [
                'title_mr' => 'विसावा मुख्य प्रवेशद्वार व वारकरी शिल्प',
                'title_en' => 'Grand Entrance Gate & Heritage Sculptures',
                'category_mr' => 'शेती व निसर्ग',
                'category_en' => 'Farm & Nature',
                'category' => 'Farm & Nature',
                'image' => 'uploads/galleries/visawa_entrance_arch_gallery.jpg',
                'sort_order' => 1,
            ],
            [
                'title_mr' => 'अशोक मामा अल्पोपहार व द्राक्ष बाग शेड',
                'title_en' => 'Ashok Mama Snack House & Vineyard Arbor',
                'category_mr' => 'शेती व निसर्ग',
                'category_en' => 'Farm & Nature',
                'category' => 'Farm & Nature',
                'image' => 'uploads/galleries/visawa_vineyard_patio_gallery.jpg',
                'sort_order' => 2,
            ],
            [
                'title_mr' => 'सेंद्रिय फळबाग व शेती शिवार',
                'title_en' => 'Organic Farming & Fruit Plantation',
                'category_mr' => 'शेती व निसर्ग',
                'category_en' => 'Farm & Nature',
                'category' => 'Farm & Nature',
                'image' => 'uploads/activities/visawa_farm_orchard.jpg',
                'sort_order' => 3,
            ],
            [
                'title_mr' => 'निसर्गरम्य दगडी पूल व पायवाट',
                'title_en' => 'Rustic Stone Bridge & Nature Trail',
                'category_mr' => 'शेती व निसर्ग',
                'category_en' => 'Farm & Nature',
                'category' => 'Farm & Nature',
                'image' => 'uploads/galleries/visawa_stone_bridge_gallery.jpg',
                'sort_order' => 4,
            ],

            // Activities
            [
                'title_mr' => 'पारंपारिक बैलगाडी शिल्प व शेतकरी सन्मान',
                'title_en' => 'Farmer & White Bullocks Heritage Sculpture',
                'category_mr' => 'उपक्रम',
                'category_en' => 'Activities',
                'category' => 'Activities',
                'image' => 'uploads/galleries/visawa_farmer_bullocks_gallery.jpg',
                'sort_order' => 5,
            ],
            [
                'title_mr' => 'देशी गिर गाई व गोशाळा',
                'title_en' => 'Indigenous Gir Cows & Goshala',
                'category_mr' => 'उपक्रम',
                'category_en' => 'Activities',
                'category' => 'Activities',
                'image' => 'uploads/galleries/visawa_gir_cows_gallery.jpg',
                'sort_order' => 6,
            ],
            [
                'title_mr' => 'झाडांच्या सावलीत निवांत खाट व झोपाळे',
                'title_en' => 'Canopy Relaxation Cots & Swings',
                'category_mr' => 'उपक्रम',
                'category_en' => 'Activities',
                'category' => 'Activities',
                'image' => 'uploads/galleries/visawa_cots_swings_gallery.jpg',
                'sort_order' => 7,
            ],
            [
                'title_mr' => 'लहान मुलांची ट्रॅक्टर ट्रेन सफर',
                'title_en' => 'Kids Mini Tractor Train Ride',
                'category_mr' => 'उपक्रम',
                'category_en' => 'Activities',
                'category' => 'Activities',
                'image' => 'uploads/activities/visawa_kids_tractor_train.jpg',
                'sort_order' => 8,
            ],

            // Events
            [
                'title_mr' => 'बाबांचा मळा भव्य उत्सव लॉन',
                'title_en' => 'Grand Celebration Lawn & Event Ground',
                'category_mr' => 'सोहळे व कार्यक्रम',
                'category_en' => 'Events',
                'category' => 'Events',
                'image' => 'uploads/galleries/visawa_celebration_lawn_gallery.jpg',
                'sort_order' => 9,
            ],
            [
                'title_mr' => 'गाडी चाकांचा लाकडी पूल – विसावा ॲग्रो',
                'title_en' => 'Cartwheel Wooden Bridge Photo Point',
                'category_mr' => 'सोहळे व कार्यक्रम',
                'category_en' => 'Events',
                'category' => 'Events',
                'image' => 'uploads/galleries/visawa_cartwheel_bridge_gallery.jpg',
                'sort_order' => 10,
            ],
            [
                'title_mr' => 'लोककला प्रदर्शन – नाद, नृत्य आणि नमन',
                'title_en' => 'Rural Folk Art & Mini Tractor Installation',
                'category_mr' => 'सोहळे व कार्यक्रम',
                'category_en' => 'Events',
                'category' => 'Events',
                'image' => 'uploads/galleries/visawa_folk_art_gallery.jpg',
                'sort_order' => 11,
            ],

            // Guest Moments & Stay
            [
                'title_mr' => 'अस्सल कोकणी पद्धतीचे कौलारू लाल दगडी कॉटेज',
                'title_en' => 'Traditional Red Stone Konkan Eco-Cottage',
                'category_mr' => 'पाहुण्यांचे क्षण',
                'category_en' => 'Guest Moments',
                'category' => 'Guest Moments',
                'image' => 'uploads/galleries/visawa_cottage_gallery.jpg',
                'sort_order' => 12,
            ],
            [
                'title_mr' => 'विंटेज अँबॅसेडर कार व सेल्फी पॉईंट',
                'title_en' => 'Vintage Ambassador Car & Selfie Point',
                'category_mr' => 'पाहुण्यांचे क्षण',
                'category_en' => 'Guest Moments',
                'category' => 'Guest Moments',
                'image' => 'uploads/galleries/visawa_vintage_car_gallery.jpg',
                'sort_order' => 13,
            ],
            [
                'title_mr' => 'लहुजी साळवे स्मरण शाळा हेरिटेज पॅव्हेलियन',
                'title_en' => 'Heritage Red Stone Arched Pavilion',
                'category_mr' => 'पाहुण्यांचे क्षण',
                'category_en' => 'Guest Moments',
                'category' => 'Guest Moments',
                'image' => 'uploads/galleries/visawa_heritage_pavilion_gallery.jpg',
                'sort_order' => 14,
            ],
            [
                'title_mr' => 'अस्सल गावरान जेवण व अमर्यादित थाळी',
                'title_en' => 'Authentic Gavran Thali & Maharashtrian Feasts',
                'category_mr' => 'खाद्यसंस्कृती',
                'category_en' => 'Food & Dining',
                'category' => 'Food & Dining',
                'image' => 'uploads/galleries/visawa_authentic_thali_gallery.png',
                'sort_order' => 8,
            ],
            [
                'title_mr' => 'पारंपरिक गावरान नाश्ता - थालिपीठ व चहा',
                'title_en' => 'Traditional Village Breakfast - Thalipeeth & Tea',
                'category_mr' => 'खाद्यसंस्कृती',
                'category_en' => 'Food & Dining',
                'category' => 'Food & Dining',
                'image' => 'uploads/galleries/visawa_village_breakfast_gallery.jpg',
                'sort_order' => 9,
            ],
            [
                'title_mr' => 'चुलीवरची झणझणीत मिसळ',
                'title_en' => 'Authentic Wood-Fired Misal Pav',
                'category_mr' => 'खाद्यसंस्कृती',
                'category_en' => 'Food & Dining',
                'category' => 'Food & Dining',
                'image' => 'uploads/galleries/visawa_wood_fired_misal_gallery.jpg',
                'sort_order' => 10,
            ],
            [
                'title_mr' => 'बागेतील ताजी सेंद्रिय फळे',
                'title_en' => 'Seasonal Farm-Fresh Organic Fruits',
                'category_mr' => 'खाद्यसंस्कृती',
                'category_en' => 'Food & Dining',
                'category' => 'Food & Dining',
                'image' => 'uploads/galleries/visawa_farm_fresh_fruits_gallery.jpg',
                'sort_order' => 11,
            ],
        ];
        ...
        $activities = [
            ...
            [
                ...
                'image' => 'uploads/activities/visawa_vineyard_patio.jpg',
                'icon' => '🍇',
                'sort_order' => 3,
                'is_active' => true,
            ],
            ...
            [
                ...
                'image' => 'uploads/activities/visawa_goshala_cows.jpg',
                'icon' => '🐂',
                'sort_order' => 6,
                'is_active' => true,
            ],
            ...
            [
                ...
                'image' => 'uploads/activities/visawa_nature_bridge.jpg',
                'icon' => '🌳',
                'sort_order' => 9,
                'is_active' => true,
            ],
        ...
        // 8. Seed Blogs with Authentic Photos
        $blogs = [
            [
                'slug' => 'experience-authentic-rural-culture-at-visawa',
                'title_mr' => 'विसावा कृषी पर्यटनाचा अद्वितीय अनुभव – बाबांचा मळा',
                'title_en' => 'Experience Authentic Rural Culture at Visawa Agro Tourism',
                'short_description_mr' => 'निसर्गाच्या सानिध्यात ग्रामीण जीवन, सेंद्रिय शेती आणि अस्सल चवींचा विसावा घ्या.',
                'short_description_en' => 'Immerse yourself in authentic rustic living, organic farming tours, and wood-fired Maharashtrian hospitality.',
                'description_mr' => 'विसावा कृषी पर्यटन – बाबांचा मळा येथे कौटुंबिक आनंद, द्राक्ष बागांची सफर, ग्रामीण खेळ आणि शांत मुक्कामाचा मनमुराद आनंद मिळतो.',
                'description_en' => 'Discover Maharashtra countryside charm with vineyard strolls, authentic chulha food, kids adventure rides, and serene cottage stays.',
                'featured_image' => 'uploads/blogs/visawa_grand_entrance_blog.jpg',
                'status' => 'active',
                'is_published' => true,
                'created_by' => $admin->id,
            ],
            [
                'slug' => 'top-reasons-to-visit-visawa-agro-tourism',
                'title_mr' => 'विसावा कृषी पर्यटनाला भेट देण्याची प्रमुख कारणे',
                'title_en' => 'Top Reasons to Visit Visawa Agro Tourism Resort',
                'short_description_mr' => 'शहरी धावपळीपासून दूर संपूर्ण कुटुंबासाठी एक परिपूर्ण वीकेंड विसावा ठिकाण.',
                'short_description_en' => 'Why Babacha Mala is Maharashtra\'s premier destination for family outings, school trips, and corporate offsites.',
                'description_mr' => 'विस्तीर्ण शिवार, बैलगाडी सफर, स्वादिष्ट गावरान मिसळ आणि कौटुंबिक सुट्टीसाठी सर्वोत्तम ठिकाण म्हणजे विसावा कृषी पर्यटन.',
                'description_en' => 'From pristine nature walks and cartwheel bridges to authentic folk traditions and pool fun, explore everything Visawa offers.',
                'featured_image' => 'uploads/blogs/visawa_cartwheel_bridge_blog.jpg',
                'status' => 'active',
                'is_published' => true,
                'created_by' => $admin->id,
            ],
